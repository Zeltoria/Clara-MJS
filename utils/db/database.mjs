...
try { accessSync(path.user) } 
catch (e) { _initFile(path.user, []) };
try { accessSync(path.grup) } 
catch (e) { _initFile(path.grup, []) };
try { accessSync(path.set) }
catch (e) { _initFile(path.set, []) };
try { accessSync(path.cmd) } 
catch (e) { _initFile(path.cmd, {}) };
