...
const { proto, downloadContentFromMessage, getContentType } = baileys;
...
const parsingMessagesHandler = (serve, m, s) => {
  try {
    ...
    if (m.key) {
      ...
      m.isGc = m.chat.endsWith(configs.idgc);
      m.isPc = m.chat.endsWith(configs.idwa);
    ...
    if (m.message) {
      ...
      m.cmd =
        m.mtype === "conversation" && m.message.conversation.startsWith(m.preff)
          ? m.message.conversation
          : m.mtype == "imageMessage" && m.message.imageMessage.caption.startsWith(m.preff)
          ? m.message.imageMessage.caption
          : m.mtype == "videoMessage" && m.message.videoMessage.caption.startsWith(m.preff)
          ? m.message.videoMessage.caption
          : m.mtype == "extendedTextMessage" && m.message.extendedTextMessage.text.startsWith(m.preff)
          ? m.message.extendedTextMessage.text
